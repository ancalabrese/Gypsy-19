...
func NewGitHubConnector(l hclog.Logger, client *http.Client, committer *CommitInfo, repo *Repo) *GitHubConnector {
...
func (ghc *GitHubConnector) GetLists() Country.Lists {
	return Country.Lists{}
}
